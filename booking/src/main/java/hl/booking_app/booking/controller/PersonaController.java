...
public class PersonaController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<GeneralResponseDto> updatePersonaById (@PathVariable("id") Integer id, @RequestBody CreatePersonaRequest req){
        ResponseHelpers<GeneralResponseDto> response = new ResponseHelpers<>();

        try{
            NpoPersona _req = dozerMapper.map(req, NpoPersona.class);
            _req.setId(id);
