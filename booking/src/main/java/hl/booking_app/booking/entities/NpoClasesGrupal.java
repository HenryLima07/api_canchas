...
public class NpoClasesGrupal implements Serializable {
    ...
    private Set<NpoAlumno> clgAlumnos = new LinkedHashSet<>();

    @OneToMany(mappedBy = "clasesGrupales")
    private Set<NpoClasesAlumno> clgClasesAlumnos = new LinkedHashSet<>();

    @OneToMany(mappedBy = "clasesGrupales")
    private Set<NpoDetallePago> clgDetallePagos = new LinkedHashSet<>();

    @OneToMany(mappedBy = "clasesGrupales")
    private Set<NpoHorariosClase> clgHorariosClases = new LinkedHashSet<>();
